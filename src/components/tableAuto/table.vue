<template>
    <div :class="wrapClasses" :style="styles">
        <div :class="classes">
            ...
            <div :class="[prefixCls + '-header']" v-if="showHeader" ref="header" @mousewheel="handleMouseWheel">
                <table-head
                    ...
                    :data="rebuildData"
                    @on-update-size="onUpdateSize"></table-head>
            </div>
        ...
        <div class="iv-table__column-resize-proxy" ref="resizeProxy" v-show="resizeProxyVisible"></div>
    </div>
</template>
<script>
    import tableHead from './table-head.vue';
    import tableBody from './table-body.vue';
    import { oneOf, getStyle, deepCopy, getScrollBarSize, on, off } from './tools';
...
import { debuglog } from 'util';
    ...
    export default {
        ...
        methods: {
            ...
            onUpdateSize (column, resizeProxyLeft) {
                ...
                this.cloneColumns.forEach(col => {
                  if (col.key) {
                    ...
                    if (this.currentColumn.key === col.key) {
                      ...
                      if (col.minWidth) {
                        col.width = parseInt(this.currentLeft) - _extraWd > col.minWidth ? parseInt(this.currentLeft) - _extraWd : col.minWidth
                      } else {
                        col.width = parseInt(this.currentLeft) - _extraWd
                      }
                    } else {
        ...
        created () {
            ...
            this.debouncedUpdateLayout = debounce(50, () => this.handleResizeProxy())
        },
        mounted () {
            this.handleResize();
